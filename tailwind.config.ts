	...
	theme: {
		...
		extend: {
			colors: {
				...
				design: {
					DEFAULT: 'hsl(var(--design))',
					foreground: 'hsl(var(--design-foreground))',
					light: 'hsl(var(--design-light))'
				},
				development: {
				...
				evaluation: {
					DEFAULT: 'hsl(var(--evaluation))',
					foreground: 'hsl(var(--evaluation-foreground))',
					light: 'hsl(var(--evaluation-light))'
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
